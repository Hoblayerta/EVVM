(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,222417,e=>{"use strict";e.i(136250);var t=e.i(498671),o=e.i(233121);e.i(256353);var r=e.i(503948);e.i(151005);var i=e.i(618358),n=e.i(83477),a=e.i(770444),s=e.i(351238),l=e.i(927677);let c=n.css`
  :host {
    position: relative;
...
`;var l=function(e,t,o,r){var i,n=arguments.length,a=n<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,o):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,o,r);else for(var s=e.length-1;s>=0;s--)(i=e[s])&&(a=(n<3?i(a):n>3?i(t,o,a):i(t,o))||a);return n>3&&a&&Object.defineProperty(t,o,a),a};let c={lg:"lg-regular",md:"lg-regular",sm:"md-regular"},u={lg:"lg",md:"md",sm:"sm"},d=class extends t.LitElement{constructor(){super(...arguments),this.size="md",this.disabled=!1,this.text="",this.loading=!1}render(){return this.loading?o.html` <wui-flex alignItems="center" gap="01" padding="01">
    ...
    `}imageTemplate(){if(this.imageSrc&&this.chainImageSrc)return o.html`<wui-flex class="left-image-container">
      ...
      >${this.text}</wui-text
    >`}};d.styles=[i.resetStyles,i.elementStyles,s],l([(0,r.property)()],d.prototype,"size",void 0),l([(0,r.property)()],d.prototype,"imageSrc",void 0),l([(0,r.property)()],d.prototype,"chainImageSrc",void 0),l([(0,r.property)({type:Boolean})],d.prototype,"disabled",void 0),l([(0,r.property)()],d.prototype,"text",void 0),l([(0,r.property)({type:Boolean})],d.prototype,"loading",void 0),d=l([(0,n.customElement)("wui-token-button")],d),e.s([],737004)}]);